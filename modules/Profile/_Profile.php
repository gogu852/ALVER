...
class Profile extends Controller
{
	...
	function setProfile()
	{
		...
		if(isset($_FILES['ownavatar']['name']) && $_FILES['ownavatar']['name'] && file_exists($_FILES['ownavatar']['tmp_name']))
		{
			...
			$account_data['custom_avatar'] = (isset($_SESSION['user_data']['custom_avatar']) && $_SESSION['user_data']['custom_avatar'])?true:false;
		
		if(!isset($account_data['custom_avatar']) || !$account_data['custom_avatar'])
		{
